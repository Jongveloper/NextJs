...
export const initialState = {
  ...
  unFollowDone: false,
  unFollowError: false,
  loadMyInfoLoading: false, // 내 정보 받아오기 시도중
  loadMyInfoDone: false,
  loadMyInfoError: false,
  loadUserLoading: false, // 유저 정보 받아오기 시도중
  loadUserDone: false,
  loadUserError: false,
  changeNicknameLoading: false, // 닉네임 변경 시도중
  changeNicknameDone: false,
  changeNicknameError: false,
  loadFollowersLoading: false, // 팔로워 받아오기 시도중
  loadFollowersDone: false,
  loadFollowersError: false,
  loadFollowingsLoading: false, // 팔로잉 받아오기 시도중
...
const dummyUser = (data) => ({
  ...
  id: 1,
  Posts: [{ id: 1 }],
  Followings: [{ nickname: '종혁' }, { nickname: '젤리' }],
  Followers: [{ nickname: '종혁' }, { nickname: '젤리' }],
});
